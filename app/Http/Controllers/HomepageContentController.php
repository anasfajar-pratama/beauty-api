...
class HomepageContentController extends Controller
{
    ...
    public function store(Request $request)
    {
        $allowed = [
            ...
            'about_title', 'about_text1', 'about_text2', 'about_quote', 'about_image',
    ...
    public function storeAbout(Request $request)
    {
        $allowed = [
            ...
            'about_story_heading', 'about_story_text1', 'about_story_text2', 'about_story_text3',
            'about_story_image',
            'about_values_title',
            ...
            'about_team_4_name', 'about_team_4_role',
        ];
